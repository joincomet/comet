...
import { usePlanets } from '@comet/corequeries/usePlanets'
    ...
    <>
      <div
        className={`slideout-menu ${
          window.electron ? 'top-6' : 'top-0'
        } left-0 bottom-0 flex flex-col items-center w-16 bg-white dark:bg-gray-900`}
      >
        <div className="h-full flex flex-col">
          <div className="flex flex-col flex-shrink">
            <Tippy content="Home" placement="right">
              <div className={planetScrollerItem}>
