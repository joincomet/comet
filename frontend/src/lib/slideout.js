...
Slideout.prototype.close = function () {
  ...
  setTimeout(function () {
    ...
    self.panel.style.transition = self.panel.style[
      '-webkit-transition'
    ] = self.panel.style[prefix + 'transform'] = self.panel.style.transform = ''
    self.emit('close')
  }, this._duration + 50)
  return this
}
...
Slideout.prototype._translateXTo = function (translateX) {
  ...
  this.panel.style[prefix + 'transform'] = this.panel.style.transform =
...
Slideout.prototype._initTouchEvents = function () {
  ...
  this._onTouchEndFn = function () {
    if (self._moved) {
      ...
      self._opening && Math.abs(self._currentOffsetX) > self._tolerance
        ? self.open()
        : self.close()
    }
    self._moved = false
