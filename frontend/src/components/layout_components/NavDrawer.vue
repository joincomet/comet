<template>
  ...
  >
    ...
    <div class="px-5 mt-9 mb-3 flex flex-row items-center">
      ...
      <div class="ml-auto rounded-full border border-gray-200 text-tiny font-bold tracking-widest uppercase text-tertiary py-1 px-4 cursor-pointer hover:bg-gray-100 inline-flex items-center">
        EXPLORE
