<template>
  <Dialog v-model="open" name="login">
    ...
    <div
      class="inline-block align-bottom bg-white dark:bg-gray-900 bg-cover text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:rounded-lg"
      role="dialog"
      aria-modal="true"
...
import RandomSpaceImage from '@/components/test/RandomSpaceImage'
...
export default {
  name: 'LoginDialog',
  components: { RandomSpaceImage, Icon, TextInput, Dialog },
  data () {
    return {
      open: false,
      tab: 0,
