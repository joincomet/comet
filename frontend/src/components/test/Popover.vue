<template>
  <div>
    ...
    <div
      ...
      class="shadow bg-white dark:bg-black border border-gray-300 dark:border-gray-800 z-50 font-normal leading-normal text-xs max-w-xs text-left no-underline break-words rounded flex flex-col"
    >
      <slot />
    </div>
  </div>
