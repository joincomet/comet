  ...
  return (
    <>
      ...
      >
        <SearchBar
          slashFocus={true}
          className={`w-full h-10 text-sm px-16 rounded-full focus:shadow-md outline-none transition ease-in-out border border-gray-200 dark:border-gray-800 focus:border-blue-500 ${
            isSticky
