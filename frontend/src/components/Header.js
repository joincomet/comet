...
export default function Header({
  ...
  return (
    <>
      ...
      <header
        style={{ top: '-1px' }}
        className={`hidden sm:flex z-10 sticky h-14 px-3 2xl:px-72 items-center transition ${
      ...
      >
        <SearchBar
          slashFocus={true}
          className={`w-full h-8 text-sm px-16 rounded-full focus:shadow-md outline-none transition border border-gray-200 dark:border-gray-800 focus:border-blue-500 dark:focus:border-blue-500 ${
            isSticky
