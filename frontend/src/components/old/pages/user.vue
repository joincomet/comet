  ...
  <div>
    ...
    >
      <v-card>
        ...
        <v-card-actions>
          <v-spacer />
          <v-btn text @click="cancelEditBio">
            Cancel
          </v-btn>
          <v-btn
            depressed
...
import UserSummaryCard from '@/components/old/user/UserSummaryCard'
import ModeratedPlanetsCard from '@/components/old/user/ModeratedPlanetsCard'
import UserCommentsScroller from '@/components/old/user/UserCommentsScroller'
...
export default {
  ...
  head () {
    if (this.selectedPost && this.dialog) { return postHead(this.selectedPost) } else { return userHead(this.user) }
  }
}
</script>
