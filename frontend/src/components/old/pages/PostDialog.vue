                ...
                <div v-if="$device.isDesktop" class="pb-3">
                  <div v-if="$store.state.currentUser">
                    <div class="pb-3">
                      ...
                      >Commenting as
                        <UsernameMenu
                          :user-data="$store.state.currentUser"
                        /></span>
                    </div>
...
<script>
import Post from '@/components/old/post/Post'
import PlanetInfoCard from '@/components/old/planet/PlanetInfoCard'
import UsernameMenu from '@/components/old/user/UsernameMenu'
import CommentSortMenu from '@/components/old/comment/sort/CommentSortMenu'
...
export default {
  ...
  components: {
    ...
    PlanetInfoCard,
    UsernameMenu,
    Editor: () => import('@/components/old/editor/Editor'),
    EditorDialog: () => import('@/components/old/editor/EditorDialog'),
    Post,
    Comment
  },
  mixins: [commentMixin],
