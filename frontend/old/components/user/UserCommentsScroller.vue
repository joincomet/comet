...
import PostDialog from '@/components/old/pages/PostDialog'
import Comment from '@/components/old/comment/Comment'
import NoPostsMessage from '@/components/old/NoPostsMessage'
...
export default {
  ...
  methods: {
    selectComment (item) {
      this.$router.push(this.post.relativeUrl)
    }
  }
}
</script>
