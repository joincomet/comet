...
import PostsScroller from '@/components/old/post/PostsScroller'
import PlanetInfoCard from '@/components/old/planet/PlanetInfoCard'
import planetGql from '@/gql/planet.graphql'
import PlanetJoinButton from '@/components/old/planet/PlanetJoinButton'
import PlanetModsCard from '@/components/old/planet/PlanetModsCard'
import { planetHead } from '@/util/planetHead'
import { postHead } from '@/util/postHead'
import InfoLinks from '@/components/old/InfoLinks'
import PlanetBar from '@/components/old/bars/PlanetBar'
import MobilePlanetJoinButton from '@/components/old/planet/MobilePlanetJoinButton'
...
export default {
  ...
  head () {
    if (this.selectedPost && this.dialog) { return postHead(this.selectedPost) } else { return planetHead(this.planet) }
  }
}
</script>
