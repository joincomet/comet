...
export class Migration20210518055202 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "server" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "name" text not null, "display_name" text not null, "description" text null, "owner_id" bigint not null, "category" text check ("category" in (\'Arts\', \'Business\', \'Culture\', \'Discussion\', \'Entertainment\', \'Gaming\', \'Health\', \'Hobbies\', \'Lifestyle\', \'Memes\', \'Meta\', \'News\', \'Politics\', \'Programming\', \'Science\', \'Sports\', \'Technology\', \'Other\')) not null, "user_count" int4 not null, "avatar_url" text null, "banner_url" text null, "is_banned" bool not null, "is_deleted" bool not null, "system_messages_channel_id" bigint null, "is_featured" bool not null, "featured_position" text null);');
    ...
    this.addSql('create table "message" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "author_id" bigint not null, "server_user_user_id" bigint null, "server_user_server_id" bigint null, "channel_id" bigint null, "group_id" bigint null, "to_user_id" bigint null, "text" text null, "image" jsonb null, "file" jsonb null, "link_metadatas" jsonb not null, "is_everyone_mentioned" bool not null, "is_pinned" bool not null, "updated_at" timestamptz(0) null, "pinned_at" timestamptz(0) null, "is_deleted" bool not null, "type" text check ("type" in (\'Normal\', \'Join\', \'Left\', \'FriendRequestReceived\')) not null);');
