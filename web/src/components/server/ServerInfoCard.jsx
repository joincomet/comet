...
export default function ServerInfoCard({
  ...
  return (
    ...
    >
      <Link
        to={`/+${server.name}`}
        className={`${className} relative relative flex flex-col w-full rounded-lg group dark:bg-gray-800 dark:hover:bg-gray-850 duration-200 transform transition hover:shadow-xl bg-white ${
          shadow ? 'shadow-lg' : ''
        }`}
      >
        <div
